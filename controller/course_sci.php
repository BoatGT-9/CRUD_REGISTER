      ...
      <div class="col-lg-4  d-none d-lg-block">
        ...
        <div id="list-example " class="list-group sticky-top ">
          ...
          <div class="my-3 card-rela">
            <a href="../view/register.php?cs_id=<?=$rs2['cs_id']?>" class="btn btn-success">ลงทะเบียน</a>
            <a href="#list-item-10" class="btn btn-primary">สอบถามเพิ่มเติม</a>
            <a class="btn btn-outline-warning" href="../view/editCourse.php?cs_id=<?=$rs2['cs_id']?>">EDIT</a>
            <a class="btn btn-outline-danger" href="del.php?cs_id=<?=$rs2['cs_id']?>" onclick="return confirm('จะลบจริงๆเบ๋อ')">DELETE</a>
          </div>
        </div>
