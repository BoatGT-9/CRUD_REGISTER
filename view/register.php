...
<body>
    ...
    <header class="bg-or-5 py-1 bg-header-img">
        <div class="container-fluid px-4 px-lg-5 my-5">
            <div class="text-center orange-theme-4">
                <h1 class="display-4 fw-bolder">แบบฟอร์มลงทะเบียนหลักสูตรฝึกอบรมระยะสั้น
                </h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <form name="frmadd" method="post" action="../controller/register.php"
                    enctype="multipart/form-data"><!-- ../controller/con_add_course.php -->

                    <input name="cs_id" type="hidden" id="ID" value="<?php echo $rs2['cs_id']; ?>"><!-- cs_id -->
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm col-form-label">
                            <?php
                            echo "<font color='#FF3300'>กรุณากรอกข้อมูลให้ถูกต้องและครบถ้วน</font>";
                            ?>
                        </label>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="re_email" class="form-control" id="re_email"
                                placeholder="คำตอบของคุณ">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm col-form-label">1. ลงทะเบียนหลักสูตรฝึกอบรมระยะสั้น
                            <?php echo $rs2['cs_name']; ?> <br>ค่าลงทะเบียน
                            <?php echo $rs2['cs_wallet']; ?>
                        </label>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="re_phonenumber" class="form-control" id="re_phonenumber"
                                placeholder="คำตอบของคุณ">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="re_IDnumber" class="form-control" id="re_IDnumber"
                                placeholder="คำตอบของคุณ">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm col-form-label">2.
                            การชำระเงินโอนผ่านธนาคารธนาคารไทยพาณิชย์ ประเภทกระแสรายวัน ชื่อบัญชี มหาวิทยาลัยราชภัฏนครปฐม
                            <br> เลขที่บัญชี 8602499555</label>
                    </div>

                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">ยืนยันการชำระเงิน</label>
                        <div class="col-sm-10">
                            <input type="text" name="re_img" class="form-control" id="re_img"
                                placeholder="ใส่ลิ้งค์รูปภาพ">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm col-form-label"> หรือยืนยันการชำระเงินผ่าน google forms
                            <p><a href="https://docs.google.com/forms/d/e/1FAIpQLScubDyU0NrSvlNwc-YiGaPtJkewjCdt6Rcyzi-PpxllY5gulQ/viewform"
                                    class="text-primary">ยืนยันการชำระเงิน</a></p>
                        </label>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm col-form-label">
                            <?php
                            echo "<font color='#FFCC00'>ระบบจะบันทึกชื่อและรูปภาพที่เชื่อมโยงกับบัญชี Google เมื่อคุณอัปโหลดไฟล์และส่งแบบฟอร์มนี้ อีเมลของคุณจะไม่รวมอยู่ในคำตอบ</font>";
                            ?>
                        </label>
                    </div> </br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-secondary btn-block"><i class="fa fa-pencil-square"
                                    aria-hidden="true"></i>ส่งข้อมูล</button>
                        </div>
